...
(function ( $ ) {
    $.fn.extend({
        ...
        mouseParallax: function(options) {
            ...
            var defaults = { moveFactor: 5, zIndexValue: "-1", targetContainer: '#slider-section, .download-area' };
...
// MOUSE MOVING BACKGTOUND
    ...
    $('#background-31').mouseParallax({
        moveFactor: 6
    });


    $('#background-32').mouseParallax({
        moveFactor: 4
    });

    $('#background-33').mouseParallax({
        moveFactor: 4
    });

    $('#background-34').mouseParallax({
        moveFactor: 4
    });

    $('#background-35').mouseParallax({
        moveFactor: 4
    });

    $('#background-36').mouseParallax({
        moveFactor: 4
    });
